    ...
    <ul>
        ...
        <li class="booking-card" style="background-image: url(https://images.pexels.com/photos/1964471/pexels-photo-1964471.jpeg)">
            ...
            <div class="informations-container">
                <h2 class="title">Nocturn'All</h2>
                <p class="sub-title">Venez assister à notre 3eme évènement dnb et acide techno avec tous les dj resident de nocturn</p>
                ...
                <div class="more-information">
                    <div class="info-and-date-container">
                        <div class="box info">
                            ...
                            <p>Pont jumeaux Toulouse</p>
                        </div>
                        <div class="box date">
                            <svg class="icon" style="width:24px;height:24px" viewBox="0 0 24 24">
                            <path fill="currentColor" d="M19,19H5V8H19M16,1V3H8V1H6V3H5C3.89,3 3,3.89 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5C21,3.89 20.1,3 19,3H18V1M17,12H12V17H17V12Z" />
                            </svg>
                            <p>Vendredi 13 Mai 2022</p>
                        </div>
                    </div>
                    <p class="disclaimer">Nous organisons à l'occasion des 1 ans de nocturn un event enervé de 12h sur de la grosse drum and bass et de la grid ainsi que de l'acid techno pour cloturer l'event. Pour voir plus de détail sur l'event et acheter vos places cliquez sur "plus d'infos" </p>
                </div>
            </div>
        </li>
