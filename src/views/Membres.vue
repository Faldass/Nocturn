            ...
            <div class="col-lg-4">
                <div class="card p-0">
                    ...
                    <div class="card-content d-flex flex-column align-items-center">
                        <h4 class="pt-2">{{team.name_team}}</h4>
                        <h5>{{team.mission_team}}</h5>

                        <ul class="social-icons d-flex justify-content-center">
                            <li style="--i:1">
                                <a :href="team.insta_team">
                                    <span><fa :icon="['fab', 'instagram']"/></span>
                                </a>
                            </li>
                            <li style="--i:2">
                                <a :href="team.fb_team">
                            ...
                            <li style="--i:3">
                                <a href="#">
                                    <span><fa :icon="['fab', 'youtube']"/></span>
                                </a>
                            </li>
                            <li style="--i:4">
                                <a :href="team.sc_team">
                                    <span><fa :icon="['fab', 'soundcloud']"/></span>
                                </a>
                            </li>
                        </ul>
                    </div>
...
<script>
    // import membreA from '@/components/Membre.vue'
    export default {
        name: 'membresA',
        components: {
            // membreA,
